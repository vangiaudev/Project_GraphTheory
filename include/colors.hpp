...
enum mainColor
{
	BACKGROUND_COLOR	= COLOR(0, 245, 255),
	wZONE_COLOR			= COLOR(128,128,128),
	LINE_COLOR			= COLOR(0,0,128),
	DOT_COLOR			= BLACK,
	LIMIT_COLOR			= GREEN
};
enum buttonColors
{
	BUTTON_COLOR				= COLOR(193, 255, 193),
	BUTTON_BORDER				= COLOR(25, 25, 112),
	BUTTON_COLOR_HIGHTLIGHT		= COLOR(255, 255, 0), //todo: fix BLUE = 241
	BUTTON_BORDER_HIGHTLIGHT	= COLOR(198, 0, 0),
	BUTTON_COLOR_CHOSE			= COLOR(255, 165, 0),
